package com.Neuralsift.Sesvo.HelperChatBot;
...
public class ChatScreenActivity extends AppCompatActivity {
    ...
    private void createServices() {
        ...
        textToSpeech = new TextToSpeech(new IamAuthenticator((mContext.getString(R.string.text_speech_apikey))));
        textToSpeech.setServiceUrl(mContext.getString(R.string.text_speech_url));

        speechService = new SpeechToText(new IamAuthenticator(mContext.getString(R.string.speech_text_apikey)));
        speechService.setServiceUrl(mContext.getString(R.string.speech_text_url));
    }
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(ChatScreenActivity.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(ChatScreenActivity.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
